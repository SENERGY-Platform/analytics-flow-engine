...
require (
	...
	github.com/SENERGY-Platform/analytics-flow-repo-v2 v0.0.22 // indirect
	github.com/SENERGY-Platform/analytics-parser/lib v0.0.0-20251021081440-4d0efa579954 // indirect
